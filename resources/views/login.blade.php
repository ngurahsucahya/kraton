                        ...
                        <form method="POST" action="{{ route('login') }}">
                            ...
                            <div class="row g-3">
                                <div class="col-12">              
                                    ...
                                    <input type="text" class="form-control border-0" placeholder="Your Username" id="username" name="username" style="height: 55px;" required>
                                </div>
                                <div class="col-12">
                                    <label for="password" class="form-label">Password</label>
                                    <input type="password" class="form-control border-0" placeholder="Your Password" id="password" name="password" style="height: 55px;" required>
                                </div>
                                <div class="col-12">
